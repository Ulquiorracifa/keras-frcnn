...
logging.basicConfig(filename='fastrcnnTraf15.log',level=logging.DEBUG)
...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='./model_frcnn15.hdf5')
