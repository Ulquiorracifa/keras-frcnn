...
from keras_frcnn import config, data_generators, data_augment
...
logging.basicConfig(filename='fastrcnnPascal.log',level=logging.DEBUG)

parser = OptionParser()

parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default="/home/asprohy/pyWorkSpace/neuralNetworks/data/pascal_voc/VOCdevkit")  #default="/home/asprohy/pyWorkSpace/neuralNetworks/data/pascal_voc/VOCdevkit")
parser.add_option("-o", "--parser", dest="parser", help="Parser to use. One of simple or pascal_voc or traf", default="pascal_voc"),
...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.",
                  default='./model_frcnnPascal.hdf5')
